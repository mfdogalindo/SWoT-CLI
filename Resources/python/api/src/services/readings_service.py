...
from models.sensor import SensorTyped
...
class ReadingsService:
    ...
    def get_readings_by_type(self, sensor_type: SensorTyped, page: int = 0, size: int = 50) -> Page:
        """Get sensor readings by type with pagination."""
        # Get total count
        count_query = SparqlQueries.COUNT_QUERY % sensor_type.observation_name
